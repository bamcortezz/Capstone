              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <div className="flex items-start mb-4 mt-6">
                  ...
                  <label
                    ...
                    className="text-sm text-gray-300 select-none flex flex-wrap items-center gap-x-1">
                    I agree to the
                    <button
                      type="button"
            ...
            <div className="p-6">
              ...
              <div className="flex flex-col items-center mb-6">
                <span className="bg-twitch/20 p-3 rounded-full mb-2">
                  <svg
                    className="w-10 h-10 text-twitch"
                    fill="none"
                    stroke="currentColor"
                    viewBox="0 0 24 24">
                    <path
                ...
                <p className="text-gray-400 text-sm text-center max-w-xs">
                  Your privacy, data security, and user rights are important to
                  us. Please review how we handle your information below.
                </p>
              </div>
              {/* Divider */}
              ...
              <div className="space-y-6">
                ...
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-gray-300 text-sm">
                      Twitch Insight and its licensors own all content,
                      trademarks, and related intellectual property. You agree
                      not to use, reproduce, or distribute content without our
                      consent.
                    </p>
                  </div>
                </div>
                ...
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-gray-300 text-sm">
                      Twitch Insight reserves the right to terminate or suspend
                      your account or access at any time for violations of these
                ...
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-gray-300 text-sm">
                      We collect your name, email, and password when you
                      register. This information is used for authentication,
                  ...
                  <span className="mt-1">
                    <svg
                      ...
                      <path
                        ...
                        strokeLinejoin="round"
                        strokeWidth="2"
                        d="M12 11c0-1.657 1.343-3 3-3s3 1.343 3 3v2a3 3 0 01-3 3h-1v2a1 1 0 01-2 0v-2h-1a3 3 0 01-3-3v-2c0-1.657 1.343-3 3-3s3 1.343 3 3z"
                      />
                    </svg>
                  </span>
                  <div>
                    ...
                    <p className="text-gray-300 text-sm">
                      ...
                      We never sell your data and only share it as required to
                      provide our services or by law.
                    </p>
                  </div>
                </div>
                {/* Your Rights */}
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-gray-300 text-sm">
                      ...
                      account and data at any time. Contact us if you have
                      questions or need assistance with your data.
                    </p>
                  </div>
                </div>
                {/* Contact */}
                  ...
                  <span className="mt-1">
                    <svg
                      ...
                      <path
                        ...
                        strokeLinejoin="round"
                        strokeWidth="2"
                        d="M16 12v1m0 4v.01M8 12v1m0 4v.01M21 12c0 4.418-4.03 8-9 8s-9-3.582-9-8a9 9 0 1118 0z"
                      />
                    </svg>
                  </span>
                  <div>
                    ...
                    <p className="text-gray-300 text-sm">
                      ...
                      page. We are committed to addressing your concerns
                      promptly.
                    </p>
                  </div>
                </div>
          ...
          <div className="bg-gray-900 rounded-lg max-w-lg w-full max-h-[90vh] overflow-y-auto relative border border-gray-700 shadow-xl">
            ...
            <div className="p-6">
              ...
              <div className="flex flex-col items-center mb-6">
                ...
                <p className="text-gray-400 text-sm text-center max-w-xs">
                  Please review the terms and conditions for using our service
                  below.
                </p>
              </div>
              <div className="border-t border-gray-700 my-4"></div>
              <div className="space-y-6">
                ...
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-gray-300 text-sm">
                      By accessing and utilizing Twitch Insight, you agree to
                      comply with and be bound by these terms and all applicable
                  ...
                  <span className="mt-1">
                    <svg
                      ...
                      <path
                        ...
                        strokeLinejoin="round"
                        strokeWidth="2"
                        d="M17 8h2a2 2 0 012 2v8a2 2 0 01-2 2H5a2 2 0 01-2-2v-8a2 2 0 012-2h2m2-4h4a2 2 0 012 2v4a2 2 0 01-2 2h-4a2 2 0 01-2-2V6a2 2 0 012-2z"
                      />
                    </svg>
                  </span>
                  <div>
                    ...
                    <p className="text-gray-300 text-sm">
                      Twitch Insight reserves the right to change, modify, or
                ...
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-gray-300 text-sm">
                      You must be at least 14 years old to use Twitch Insight.
                      By registering, you represent and warrant that you meet
