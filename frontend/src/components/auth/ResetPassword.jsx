    ...
    const validateToken = async () => {
      try {
        const response = await fetch(
          `${API_URL}/api/validate-reset-token/${userId}/${token}`,
          {
            method: "GET",
            headers: {
          ...
          <div className="max-w-7xl mx-auto">
            <div className="max-w-md mx-auto">
              <div className="bg-black p-8 rounded border border-gray-700 shadow-xl text-center">
                ...
                <Link
                  to="/forgot-password"
                  className="inline-block py-3 px-6 rounded-lg bg-twitch hover:bg-twitch-dark text-white font-medium transition-colors">
                  Request New Link
                </Link>
              </div>
            </div>
