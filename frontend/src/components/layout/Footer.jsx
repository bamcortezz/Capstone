      ...
      <div className="max-w-7xl mx-auto">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div className="col-span-1 md:col-span-2">
            <h3 className="text-white text-lg font-semibold mb-4">Twitch Sentiment Analysis</h3>
            <p className="text-gray-400 mb-4 max-w-md">
              Understand your Twitch chat better with real-time sentiment analysis and engagement metrics.
            </p>
            <div className="flex space-x-4">
              ...
              <a href="https://github.com" target="_blank" rel="noopener noreferrer" className="text-gray-400 hover:text-gray-100 transition-colors">
                <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24">
        ...
        <div className="border-t border-gray-700 mt-8 pt-8 text-center">
          <p>&copy; {new Date().getFullYear()} Twitch Sentiment Analysis. All rights reserved.</p>
        </div>
      </div>
    </footer>
  );
