...
const Settings = () => {
  ...
  const handleProfileSave = async () => {
    try {
      ...
      // Only update first and last name - email is handled separately
      await updateProfile({
        first_name: profileForm.first_name,
        last_name: profileForm.last_name,
        email: user.email, // Keep current email unchanged
      });
    ...
    <div className="min-h-screen bg-black flex justify-center items-start py-12 px-4">
      <div className="w-[1000px] bg-black flex flex-col md:flex-row gap-8 p-8 rounded-xl shadow-lg">
        ...
        <div className="md:w-1/3 w-full bg-black border border-gray-700 rounded-lg p-6 flex flex-col items-center md:items-stretch">
          ...
          <button
            className={sidebarBtn("password")}
            onClick={() => setActiveSection("password")}
          >
            Change Password
          </button>
          <button
            className={sidebarBtn("delete")}
                  ...
                  <div className="md:col-span-2">
                    ...
                    <div className="flex gap-2">
                      <input
                        ...
                        disabled
                        className="flex-1 px-4 py-2 rounded-md bg-gray-800 text-gray-400 border border-gray-600 cursor-not-allowed"
                      />
                      <button
                        onClick={() => setShowEmailChangeModal(true)}
                        className="px-3 py-2 bg-twitch hover:bg-twitch-dark text-white rounded-md transition-colors flex items-center justify-center"
                        title="Change Email"
                      >
                        <svg
                          className="w-5 h-5"
          ...
          {activeSection === "password" && (
            <div className="bg-black border border-gray-700 rounded-lg p-6">
              ...
              <div className="flex flex-col gap-6">
                ...
                <button
                  type="button"
                  className={`w-full py-3 rounded-lg font-medium transition-colors flex items-center justify-center mt-2 bg-twitch hover:bg-twitch-dark text-white ${
          ...
          {activeSection === "delete" && (
            <div className="bg-black border border-gray-700 rounded-lg p-6">
              ...
              <div className="flex flex-col gap-6">
                ...
                <div>
                  ...
                  <div className="relative">
                    ...
                    <button
                      type="button"
                      onClick={() =>
                        setShowDeleteConfirmPassword((prev) => !prev)
                      }
                      className="absolute inset-y-0 right-0 flex items-center pr-3 text-gray-400 hover:text-white focus:outline-none"
                      tabIndex={-1}
                    >
                ...
                <button
                  type="button"
                  className={`w-full py-3 rounded-lg font-medium transition-colors flex items-center justify-center mt-2 bg-red-600 hover:bg-red-700 text-white ${
